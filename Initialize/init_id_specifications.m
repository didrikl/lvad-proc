function idSpecs = init_id_specifications(workbookFile)
    ...
    opts.VariableNames = ["categoryLabel", "levelLabel",  "idLabel",     "analysis_id", "analysisDuration", "interventionType", "extra",       "contingency", "QRedTarget_pst", "pumpSpeed", "catheter",    "balLev",      "balDiam", "balVol", "arealOccl_pst"];
