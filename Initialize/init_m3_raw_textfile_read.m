function signal = init_m3_raw_textfile_read(filename, startRow, endRow)
    ...
    %   ECM20190628155828 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
    %   for the default selection.
    %
    %   ECM20190628155828 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
    %   rows STARTROW through ENDROW of text file FILENAME.
    %
    % Example:
    %   ECM20190628155828 = importfile('ECM_2019_06_28__15_58_28.wrf', 1, 15);
    %
    %    See also TEXTSCAN.
    
    % Auto-generated by MATLAB on 2019/08/05 13:37:44
