...
varB = 'accB_y';
partSpecNo = 1;
[hFig, mapA, mapB, T] = make_h3_bland_altmann(Data.G1B1, seq, varA, varB, partSpecNo);
...
%hFig = make_h3_bland_altmann(Data.G1B1, seq, varA, varB, partSpecNo, mapA, mapB, T);
...
%save_figure(hFig, fullfile(Config.fig_path,'Accelerometer comparisons'), hFig.Name, 'png', 600);
