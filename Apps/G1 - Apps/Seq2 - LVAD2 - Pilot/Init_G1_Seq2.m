...
sequence = 'Seq2 - LVAD2 - Pilot';
Config.seq_subdir = ['G1 - Simulated pre-pump and in situ thrombosis\Seq2 - LVAD2 - Pilot'];
...
Config.notes_fileName = 'G1_Seq2 - Notes ver3.12 - Rev5.xlsm';
