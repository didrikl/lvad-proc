...
sequence = 'Seq8 - LVAD1';
pc.seq_subdir = 'G1 - In vivo pre-pump thrombosis simulation\Seq8 - LVAD1';
...
%pc.labChart_fileNames = {'G1_Seq8 - F3_Sel1.txt'}      % 

pc.notes_fileName = 'G1_Seq8 - Notes ver4.16 - Rev7.xlsm';
