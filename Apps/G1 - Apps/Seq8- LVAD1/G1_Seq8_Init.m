...
sequence = 'Seq8 - LVAD1';
experiment_subdir = 'G1 - In vivo pre-pump thrombosis simulation\Seq8 - LVAD1';
...
%labChart_fileNames = {'G1_Seq8 - F3_Sel1.txt'}      % 

notes_fileName = 'G1_Seq8 - Notes ver4.16 - Rev7.xlsm';
