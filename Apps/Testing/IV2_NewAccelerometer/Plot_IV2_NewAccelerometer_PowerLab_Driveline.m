...
for i=1:numel(parts)
    ...
    [T,rpms] = make_plot_data(parts{i},S_PL_parts,rpm{i},sampleRate,bl_part,cbl_part);
     h_fig = plot_ordermap_with_vars(...
         T,orderMapVar,sampleRate,bl_part,mapColScale,notes,circ_ylim);
     fig_name = sprintf('Spectrogram - %s - NewAccelerometer - PowerLab - Driveline - LVAD - RPM=%s - No catheter - %s',...
