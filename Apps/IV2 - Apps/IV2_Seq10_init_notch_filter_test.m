...
experiment_subdir = 'IV2 - In vitro pre-pump thrombosis simulation\Seq10 - LVAD9';
...
notes_fileName = 'IV2_Seq10 - Notes ver4.9 - Rev2.xlsm';
ultrasound_fileNames = {
    %'ECM_2020_09_03__15_55_28.wrf'
    '...wrf'
...
US1 = adjust_for_linear_time_drift(US1);
US2 = adjust_for_linear_time_drift(US2,40.5);
US = [US1;US2];
