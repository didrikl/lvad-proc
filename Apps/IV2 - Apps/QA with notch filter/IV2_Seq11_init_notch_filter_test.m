...
Config.seq_subdir = 'IV2 - In vitro pre-pump thrombosis simulation\Seq11 - LVAD10';
...
Config.notes_fileName = 'IV2_Seq11 - Notes ver4.9 - Rev2.xlsm';
...
US1 = adjust_for_linear_time_drift(US1,40);
US2 = adjust_for_linear_time_drift(US2,12);
US = [US1;US2;US3];
