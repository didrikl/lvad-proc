...
Config.seq_subdir = 'IV2 - In vitro pre-pump thrombosis simulation\Seq9 - LVAD6';
...
Config.notes_fileName = 'IV2_Seq9 - Notes ver4.9 - Rev2.xlsm';
...
US1_and_2 = init_system_m_text_files(ultrasound_filePaths(1:2),'',systemM_varMap);
...
US1_and_2 = adjust_for_linear_time_drift(US1_and_2,37);
US3 = adjust_for_linear_time_drift(US3,45);
US = [US1_and_2;US3];
