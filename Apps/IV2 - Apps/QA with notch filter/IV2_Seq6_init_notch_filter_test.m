...
notes = init_notes_xlsfile_ver4(notes_filePath,'','VarMap_Notes_IV2_v1');
...
US2 = adjust_for_linear_time_drift(US2,24.5);
US = [US1;US2];
...
analysis_ids = categories(S.analysis_id);
S_analysis{1} = S(S.analysis_id==analysis_ids{1},:);
