...
sequence = 'IV2_Seq3';
Config.seq_subdir = 'IV2_Seq3 - Water simulated HVAD thrombosis - Pilot';
...
Config.notes_fileName = 'IV2_Seq3 - Notes ver3.9 - Rev3.xlsm';
...
ultrasound_filePaths  = fullfile(basePath,Config.seq_subdir,spectrum_subdir,Config.ultrasound_fileNames);
