...
sequence = 'IV2_Seq11';
Config.seq_subdir = 'IV2 - Simulated pre-pump thrombosis in 5pst glucose\Seq11 - LVAD10';
...
Config.notes_fileName = 'IV2_Seq11 - Notes ver4.9 - Rev1.xlsm';
...
Fs = 700;
for i=1:2
    S_parts{i}.accA_normLowPass = lowpass(S_parts{i}.accA_norm,Fpass(i),Fs);
end
S_parts = add_moving_statistics(S_parts,{'accA_normLowPass'});
