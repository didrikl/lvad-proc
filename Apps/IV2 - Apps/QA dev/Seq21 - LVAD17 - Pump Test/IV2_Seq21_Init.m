...
sequence = 'IV2_Seq21';
Config.seq_subdir = 'IV2 - Simulated pre-pump thrombosis in 5pst glucose\Seq21 - LVAD17 - Pump test';
...
Config.labChart_fileNames = {
    'IV2_Seq21 - F1 [accA,accB,pAff,pEff].mat'
    };
cardibox_fileNames = { 
    };
Config.notes_fileName = 'IV2_Seq21 - Notes ver4.9 - Rev0.xlsm';
Config.ultrasound_fileNames = {
    'ECM_2020_12_18__18_30_01.wrf'
    };
