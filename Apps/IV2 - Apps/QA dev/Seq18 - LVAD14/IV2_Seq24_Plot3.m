...
parts = {
   [],   [1],  [],   '01. Pump speed, before PCI catheters'
    [],   [2],  [],   '11. Balloon at inlet, 4.5mm x 20mm, 2200 RPM'
    [],   [3],  [],   '12. Balloon at inlet, 4.5mm x 20mm, 2500 RPM'
    [],   [4],  [],   '13. Balloon at inlet, 4.5mm x 20mm, 2800 RPM'
    [],   [5],  [],   '14. Balloon at inlet, 4.5mm x 20mm, 3100 RPM'
    [],   [7],  [],   '21. Balloon at inlet, 6mm x 20mm, 2200 RPM'
    [],   [8],  [],   '22. Balloon at inlet, 6mm x 20mm, 2500 RPM'
    [],   [9],  [],   '23. Balloon at inlet, 6mm x 20mm, 2800 RPM'
    [],   [10],  [],   '24. Balloon at inlet, 6mm x 20mm, 3100 RPM'
    [],   [11],  [],   '31. Balloon at inlet, 8mm x 30mm, 2200 RPM'
     [],   [12],  [],   '32. Balloon at inlet, 8mm x 30mm, 2500 RPM'
    [],   [13],  [],   '33. Balloon at inlet, 8mm x 30mm, 2800 RPM'
    [],   [14],  [],   '34. Balloon at inlet, 8mm x 30mm, 3100 RPM'
    %[],   [],  [],   '41. Pump speed, before 11mm catheter insertion'
    [],   [15],  [],   '42. Balloon at inlet, 11mm, 2200 RPM'
    [],   [16],  [],   '43. Balloon at inlet, 11mm, 2500 RPM'
    [],   [17],  [],   '44. Balloon at inlet, 11mm, 2800 RPM'
    [],   [18],  [],   '45. Balloon at inlet, 11mm, 3100 RPM'
    [],   [19],  [],   '51. Nominal flow for afterload clamp'
    {19,176},   [20],  [],   '52. Afterload increase clamp, 2200 RPM'
    {19,174},   [21],  [],   '53. Afterload increase clamp, 2500 RPM'
    {19,172},   [22],  [],   '54. Afterload increase clamp, 2800 RPM'
    {19,170},   [23],  [],   '55. Afterload increase clamp, 3100 RPM'
    {},   [24],  [],   '61. Nominal flow for preload clamp'
    {24,225},   [25],  [],   '62. Preload decrease clamp, 2200 RPM'
    {24,223},   [26],  [],   '63. Preload decrease clamp, 2500 RPM'
    {24,221},   [27],  [],   '64. Preload decrease clamp, 2800 RPM'
    {24,219},   [28],  [],   '65. Preload decrease clamp, 3100 RPM'
    {},   [29],  [],   '66. Nominal flow, after preload clamp'
    {},   [29,30],  [],   '70. RPM ramping'
    };
...
function [T,rpm] = make_plot_data(parts,T,rpm,fs,bl_part,cbl_part,movStdVar)
    ...
    if numel(bl_part)==2
        T{bl_part{1}} = T{bl_part{1}}(T{bl_part{1}}.noteRow==bl_part{2},:);
        all_parts = [bl_part{1},sort([parts,cbl_part])];
    else
        all_parts = parts;
    end
    
    T = merge_table_blocks(T(all_parts));
...
function add_interv_bar(h,T,notes,mapVar)
    ...
    titleStr = {'\bfRPM\rm',rpms,'\bfVariable\rm',strrep(mapVar,'_','\_')};
    
    annotation(gcf,'textbox',...
        'Position',[0.8622 0.857 0.1277822 0.070402],...
        'FitBoxToText','on',...
...
function add_circulation(h,T)
    ...
    %         'HandleVisibility','off');
    %     T.p_graft_shift(not(fullColorRows)) = nan;
    %     plot(T.t,T.p_graft_shift,...
    %         'LineWidth',0.75,...
    %         'LineStyle','-',...
