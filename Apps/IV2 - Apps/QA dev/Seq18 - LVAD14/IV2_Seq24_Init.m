...
sequence = 'IV2_Seq18';
Config.seq_subdir = 'IV2 - In vitro pre-pump thrombosis simulation\Seq18 - LVAD14';
...
Config.notes_fileName = 'IV2_Seq18 - Notes ver4.9 - Rev1.xlsm';
...
US.Q_graft = mean([US.effQ,US.affQ],2);
US.affQ = [];
US.effQ = [];
