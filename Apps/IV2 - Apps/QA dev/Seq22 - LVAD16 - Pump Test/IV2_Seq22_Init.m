...
sequence = 'IV2_Seq22';
Config.seq_subdir = 'IV2 - Simulated pre-pump thrombosis in 5pst glucose\Seq22 - LVAD16 - Pump test';
...
Config.labChart_fileNames = {
    'IV2_Seq22 - F1 [accA,accB,pAff,pEff].mat'
    };
cardibox_fileNames = { 
    };
Config.notes_fileName = 'IV2_Seq22 - Notes ver4.9 - Rev0.xlsm';
Config.ultrasound_fileNames = {
    'ECM_2020_12_18__19_39_12.wrf'
    };
