...
make_fft_plots(S_part(S_part.balLev=='1',:),'accA_norm',rpm);
title('Level 1')
h_sub(2) = subplot(3,1,2);
make_fft_plots(S_part(S_part.balLev=='2',:),'accA_norm',rpm);
title('Level 2')
h_sub(3) = subplot(3,1,3);
make_fft_plots(S_part(S_part.balLev=='3',:),'accA_norm',rpm);
title('Level 3')
% h_sub(4) = subplot(3,2,4);
% make_fft_plots(S_part(S_part.balLev=='3',:),'accA_norm',rpm);
% title('Level 3')
% h_sub(5) = subplot(3,2,5);
% make_fft_plots(S_part(S_part.balLev=='4',:),'accA_norm',rpm);
% title('Level 4')
% h_sub(6) = subplot(3,2,6);
% make_fft_plots(S_part(S_part.balLev=='5',:),'accA_norm',rpm);
% title('Level 5')
