...
save_table('Power spectra densities', analysis_path, psds, 'matlab');

multiWaitbar('CloseAll');

%% Make tables for ROC

F_ROC_PCI3 = F(F.pumpSpeed=='2500' & ( F.interventionType=='Control' | ...
    F.levelLabel=='Inflated,  8.52 mm' ),:);

    ...'Inflated,  11 mm'...
    ...'Inflated,  4.73 mm',...
    ...'Inflated,  6.60 mm',...
save_table('Features - ROC - PCI 3', analysis_path, F_ROC_PCI3, 'spreadsheet');
save_table('Features - ROC - PCI 3', analysis_path, F_ROC_PCI3, 'text');
...
load(fullfile(analysis_path,'Power spectra densities'))
