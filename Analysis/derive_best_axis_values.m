...
function F = find_best_axis_per_speed(F, newVar, vars, seqs)
	...
	for i=1:numel(seqs)
		...
		for j=1:numel(speeds)
			...
			F.([newVar,'_axis'])(seq_inds & s_inds) = vars(col);
