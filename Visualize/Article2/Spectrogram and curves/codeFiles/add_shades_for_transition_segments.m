function add_shades_for_transition_segments(hSub, segs, yLims1, yLims2)
	...
	add_shades(hSub(1), segs, segs.all.isTransitional, shadeColor, 0.31, [yLims1(1) yLims1(2)])
	for i=2:numel(hSub)
		add_shades(hSub(i), segs, segs.all.isEcho, echoShadeColor, 0.18, [yLims2(1) yLims2(2)])
		add_shades(hSub(i), segs, segs.all.isTransitional, shadeColor, 0.55, [yLims2(1) yLims2(2)])
	end
