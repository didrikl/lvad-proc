...
% Add norm of bandbower over x, y, and z
F.accB_xyz_NF_HP_b1_pow_norm = sqrt( sum( F{:,{'accB_x_NF_HP_b1_pow','accB_y_NF_HP_b1_pow','accB_z_NF_HP_b1_pow'}}.^2,2,"omitnan"));
F.accB_xyz_NF_HP_b2_pow_norm = sqrt( sum( F{:,{'accB_x_NF_HP_b2_pow','accB_y_NF_HP_b2_pow','accB_z_NF_HP_b2_pow'}}.^2,2,"omitnan"));
