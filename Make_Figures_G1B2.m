...
close all
make_part_figure_2panels_with_nha_G1B2(T1, T2, map1, map2, Notes, var, partSpec(i,:), Config.fs, yLims1, yLims2, yTicks2, widthFactor);
...
plot_nha_power_and_flow_3x5panels_G1B2(F_rel, G_rel.med, [], var, yLims);
...
plot_roc_per_balloon_level(Data.G1B2.Feature_Statistics.ROC, Data.G1B2.Feature_Statistics.ROC_Pooled_RPM, classifiersToUse, classifiersToUseForPooled);
