...
%     stats.balLev = cellstr(repmat("",numel(ids)*numel(seqs),1));
    ...
    S1 = S_analysis.(seqs{1});
    S2 = S_analysis.(seqs{2});
    S3 = S_analysis.(seqs{3});
    S4 = S_analysis.(seqs{4});
    S5 = S_analysis.(seqs{5});
    S6 = S_analysis.(seqs{6});
    S7 = S_analysis.(seqs{7});
    S8 = S_analysis.(seqs{8});
    S9 = S_analysis.(seqs{9});
    S10 = S_analysis.(seqs{10});
    clear S_analysis
